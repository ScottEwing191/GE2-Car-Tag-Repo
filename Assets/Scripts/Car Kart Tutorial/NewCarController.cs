...
namespace CarTag.CarKartTutorial
{
    public class NewCarController : MonoBehaviour
    {
        ...
        {
            public NewCarController.Stats modifiers;
        ...
        public NewCarController.Stats baseStats = new NewCarController.Stats
        {
            TopSpeed            = 10f,
            Acceleration        = 5f,
        ...
        NewCarController.Stats m_FinalStats;
        ...
        void FixedUpdate()
        {
            ...
            if (m_CanMove)
            {
                ...
                bool accelerate = UnityEngine.Input.GetKey(KeyCode.W);
                bool brake = UnityEngine.Input.GetKey(KeyCode.S);
                float turn = UnityEngine.Input.GetAxis("Horizontal");
